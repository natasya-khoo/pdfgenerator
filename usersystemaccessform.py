...
from pdf_saver import autosave_form_pdf
...
class UserSystemAccessForm(tk.Frame):
    def __init__(self, parent, controller):
        """
        Initialize the User System Access Form frame.
        """
